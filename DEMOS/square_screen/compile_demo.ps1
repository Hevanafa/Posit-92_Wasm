...
# $pinfo.Arguments = "-Pwasm32", "-Tembedded", "-Fu..\..\experimental\units", "-dWASM", "-o$outputFile", $primaryUnit
$pinfo.Arguments = "-Pwasm32", "-Tembedded", "-FuUNITS", "-dWASM", "-Xs", "-XX", "-o$outputFile", $primaryUnit
